...
export default function Footer() {
    return (
        <div className="flex flex-col relative bottom-0 w-svw lg:w-[98.9vw] z-40 bg-neutral-400 lg:h-60 justify-between border border-t-neutral-950 border-t-dashed ">
            <div>
