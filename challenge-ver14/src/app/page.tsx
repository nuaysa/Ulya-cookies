  ...
  return (
    <>
        <div className="relative flex flex-col max-w-screen max-h-screen sm:flex-col lg:flex-row">
          ...
          <div className="max-h-[800px] hidden lg:flex">
            <Image 
            alt="foto" 
        ...
        <div className="pt-20 lg:pt-10 bg-neutral-300 lg:h-[700px] lg:py-7 p-6">
          <div className="flex flex-col lg:flex-row lg:justify-between justify-evenly gap-10 bg-gradient-to-r h-[850px] lg:h-[600px] from-neutral-800 to-neutral-600  lg:px-9 p-7 rounded-lg">
            ...
            <div className="flex flex-col text-white text-center lg:text-start lg:justify-between text-sm lg:text-xl p-4 lg:w-1/2">
              <h1 className="text-center font-extrabold text-2xl lg:text-5xl bg-neutral-700 rounded-sm p-3 lg:p-6">Our Products</h1>
              <div>
